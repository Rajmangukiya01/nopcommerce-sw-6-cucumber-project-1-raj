...
public class RegisterSteps {
    ...
    public void enterLastName() {
        new RegisterPage().enterLastName("Cina");
    }
    ...
    public void enterEmail() {
        new RegisterPage().enterEmail("john019@gmail.com");
    }

    @And("^Enter password$")
    public void enterPassword() {
        new RegisterPage().enterPassword("John@001");
    }

    @And("^Enter confirm password$")
    public void enterConfirmPassword() {
        new RegisterPage().enterConfirmPassword("John@001");
